...
class CaptureAadhaarBackSceen extends StatefulWidget {
  const CaptureAadhaarBackSceen({super.key});

  @override
  State<CaptureAadhaarBackSceen> createState() =>
      _CaptureAadhaarBackSceenState();
}

class _CaptureAadhaarBackSceenState extends State<CaptureAadhaarBackSceen> {
  @override
  void initState() {
    super.initState();
